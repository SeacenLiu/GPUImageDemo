...
#define kDefaultSmoothIntensity 0.5
...
- (id)init;
{
    ...
    self.smoothIntensity = kDefaultSmoothIntensity;
    ...
    combinationFilter.intensity = self.smoothIntensity;
...
- (void)setSmoothIntensity:(CGFloat)smoothIntensity {
    _smoothIntensity = smoothIntensity;
